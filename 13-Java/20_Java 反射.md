...
Class 对象、获取构造器/方法/字段、动态调用、访问私有成员、反射性能、setAccessible、模块系统限制 (Java 9+)。
...
> **Note:** 💡 反射要点: Class 对象 3 种获取方式; getMethod/getField/getConstructor 获取成员; invoke/set/get 动态调用/访问; setAccessible 访问私有成员; 动态代理 (InvocationHandler) 实现 AOP; 反射性能开销大, 需要缓存; MethodHandles 更快; Java 9+ 模块限制反射; 框架核心机制。


## 练习


<!-- Converted from: 20_Java 反射.html -->
