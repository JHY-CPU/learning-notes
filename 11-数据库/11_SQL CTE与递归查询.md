...
WITH 公用表表达式、CTE vs 子查询、递归 CTE (WITH RECURSIVE)、层级数据查询 (组织树/分类树/路径枚举)、实际应用场景。
...
> **Note:** 💡 CTE 要点: WITH 定义临时结果集; 可多次引用提升可读性; RECURSIVE 实现递归查询 (树/图); 锚点+递归+终止条件; 用于组织树、分类路径、日期序列、图遍历。


## 练习


<!-- Converted from: 11_SQL CTE与递归查询.html -->
